      ...
      body: Center(
        ...
        Column(
          children: [
            Row(
              children: [
                Text("Bienvenue dans l'application de Quizz"),
                Text("Quelle est la meilleur des équipes ?"),
            ...
            Column(
              children: [
                TextButton(onPressed: (){}, child: Text("DTC")),
                TextButton(onPressed: (){}, child: Text("MAD")),
              ],
            ),
            ],),
            Column(
            ...
            Column(
              children: [
                TextButton(onPressed: (){}, child: Text("CTT")),
                TextButton(onPressed: (){}, child: Text("PIL")),
              ],
            ),
                ],),
          ],
